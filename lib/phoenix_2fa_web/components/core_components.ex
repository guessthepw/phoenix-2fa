defmodule Phoenix2FAWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(Phoenix2FAWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(Phoenix2FAWeb.Gettext, "errors", msg, opts)
    end
  end
