defmodule WebAuthnLiveviewWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(WebAuthnLiveviewWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(WebAuthnLiveviewWeb.Gettext, "errors", msg, opts)
    end
  end
